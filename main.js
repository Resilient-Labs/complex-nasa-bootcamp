...
fetch("https://data.nasa.gov/api/views/gvk9-iz74/rows.json?api_key=Hw2aLYfaBgr4k0FnIlOe6A18j9nGTQdhQqGA1thI")
.then(res => res.json())
.then(response => {
...
window.addEventListener('load',() => {
  let api = "https://data.nasa.gov/api/views/gvk9-iz74/rows.json?api_key=Hw2aLYfaBgr4k0FnIlOe6A18j9nGTQdhQqGA1thI"
  console.log(api);
  fetch(api)
  .then(res => res.json())
  .then(response => {
